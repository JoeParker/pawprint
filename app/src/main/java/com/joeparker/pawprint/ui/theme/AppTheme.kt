...
package com.joeparker.pawprint.ui.theme
...
/**
 * A [MaterialTheme] for the app.
 */
@Composable
fun AppTheme(content: @Composable () -> Unit) {
    val colors = darkColors(
        primary = PawPrintGreen,
        secondary = PawPrintMidBlue,
        surface = PawPrintDarkBlue,
        onSurface = Color.White,
        background = PawPrintDarkBlue,
